    ...
    const defaultProviders: AIProviderConfig[] = [
      {
        ...
        name: 'Antigravity Claude 3.7 (Thinking)',
        displayName: 'Antigravity Claude 3.7 Sonnet (Deep Thinking & Multi-Taint Graph)',
      ...
      {
        id: 'antigravity-claude-3-6-sonnet',
        name: 'Antigravity Claude 3.6 (IaC & AST)',
        displayName: 'Antigravity Claude 3.6 Sonnet (AST & Container Auditor)',
        model: 'antigravity-claude-3-6-sonnet',
        status: 'AVAILABLE',
        priority: 2,
        requestCount: 36,
        errorCount: 0,
      ...
      {
        id: 'antigravity-claude-3-5-sonnet',
        name: 'Antigravity Claude 3.5 (Security Logic)',
        displayName: 'Antigravity Claude 3.5 Sonnet (Prompt Risk & CVE Engine)',
        model: 'antigravity-claude-3-5-sonnet',
        status: 'AVAILABLE',
        priority: 3,
        requestCount: 52,
        errorCount: 0,
        lastUsed: new Date(Date.now() - 1000 * 60 * 4).toISOString(),
        hasApiKey: true,
      },
      {
        id: 'antigravity-pro',
        ...
        requestCount: 32,
        errorCount: 0,
        lastUsed: new Date(Date.now() - 1000 * 60 * 6).toISOString(),
        hasApiKey: true,
      },
      {
        id: 'antigravity-flash',
        name: 'Antigravity Flash (Fast Scanner)',
        displayName: 'Antigravity AI Flash (AST & Rapid Detection)',
